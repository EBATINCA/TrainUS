...
#------------------------------------------------------------------------------
#
# ExerciseOutPlaneNeedleInsertion
#
#------------------------------------------------------------------------------
class ExerciseOutPlaneNeedleInsertion(ScriptedLoadableModule):
  
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "Exercise Out-Of-Plane Needle Insertion"
...
#------------------------------------------------------------------------------
#
# ExerciseOutPlaneNeedleInsertionWidget
#
#------------------------------------------------------------------------------
class ExerciseOutPlaneNeedleInsertionWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def __init__(self, parent):
    ...
    # Create logic class
    self.logic = ExerciseOutPlaneNeedleInsertionLogic(self)

    slicer.ExerciseOutPlaneNeedleInsertionWidget = self # ONLY FOR DEVELOPMENT
  ...
  def setupUi(self):    
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/ExerciseOutPlaneNeedleInsertion.ui'))
  ...
  def onSaveRecordingButtonClicked(self):
    ...
    # Create new recording
    slicer.trainUsWidget.logic.recordingManager.createNewRecording(Parameters.EXERCISE_BASIC_OUTPLANE_INSERTION, recordingDuration)
...
#                                                                                             #
#                                                                                             #
#                        ExerciseOutPlaneNeedleInsertionLogic                                  #
#                                                                                             #
#                                                                                             #
#                                                                                             #
#---------------------------------------------------------------------------------------------#
class ExerciseOutPlaneNeedleInsertionLogic(ScriptedLoadableModuleLogic, VTKObservationMixin):
  ...
  def __init__(self, widgetInstance, parent=None):
    ...
    # Data path
    self.dataFolderPath = self.moduleWidget.resourcePath('ExerciseOutPlaneNeedleInsertionData/')
    self.metricsDirectory = self.moduleWidget.resourcePath('ExerciseOutPlaneNeedleInsertionData/Metrics/')
  ...
  def loadTarget(self):
    ...
    try:
      self.targetPointNode = slicer.util.loadMarkups(targetFilePath)
...
#------------------------------------------------------------------------------
#
# ExerciseOutPlaneNeedleInsertionTest
#
#------------------------------------------------------------------------------
class ExerciseOutPlaneNeedleInsertionTest(ScriptedLoadableModuleTest):
...
#
class ExerciseOutPlaneNeedleInsertionFileWriter(object):
  def __init__(self, parent):
    pass
