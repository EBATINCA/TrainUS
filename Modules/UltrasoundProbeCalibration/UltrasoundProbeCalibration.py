...
class UltrasoundProbeCalibrationLogic(ScriptedLoadableModuleLogic):
...
class UltrasoundProbeCalibrationTest(ScriptedLoadableModuleTest):
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_UltrasoundProbeCalibration1()

  def test_UltrasoundProbeCalibration1(self):
    ...
    import SampleData
    registerSampleData()
    inputVolume = SampleData.downloadSample('UltrasoundProbeCalibration1')
    ...
    logic = UltrasoundProbeCalibrationLogic()
